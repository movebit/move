...
mod tests {
    ...
    fn test_generate_spec_request_001() {
        ...
        let request = Request {
            id: "generate_spec_file_request_001".to_string().into(),
            method: String::from("move/generate/spec/file"),
            params: params_json,
        };
    ...
    fn test_generate_spec_request_002() {
        ...
        let request = Request {
            id: "generate_spec_file_request_002".to_string().into(),
            method: String::from("move/generate/spec/file"),
            params: params_json,
        };
